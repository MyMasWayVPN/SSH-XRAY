...
echo "Checking VPS"
IZIN=$( curl https://raw.githubusercontent.com/MyMasWayVPN/MyMasWayVPN.github.io/main/wkwkwkwk | grep $MYIP )
if [ $MYIP = $MYIP ]; then
...
# ==================================================
# Link Hosting Kalian
tarapkuhing="raw.githubusercontent.com/MyMasWayVPN/SSH-XRAY/main/ssh"
...
cd /etc/openvpn/
wget https://raw.githubusercontent.com/MyMasWayVPN/SSH-XRAY/main/ssh/vpn.zip
unzip vpn.zip
rm -f vpn.zip
