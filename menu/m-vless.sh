...
echo -e "${BR}┌─────────────────────────────────────────────────┐"
echo -e "${BR}│  ${NC}                  PANEL VLESS                   ${BR}│${NC}"
echo -e "${BR}└─────────────────────────────────────────────────┘"
echo -e "${BR}┌─────────────────────────────────────────────────┐"
...
echo -e "${RED} —————————————————————————————————————————————————${NC}"
echo -e "${BR}┌─────────────────────────────────────────────────┐${NC}"
echo -e "${IJO}   1.)${NC}☞${UNG}ADD VLESS${NC} "
echo -e "${BR}│${NC} ${IJO} 2.)${NC}☞${UNG}RENEW VLESS${NC}"
echo -e "${IJO}   3.)${NC}☞${UNG}DELETE VLESS${NC}"
echo -e "${BR}│ ${NC} ${IJO}4.)${NC}☞${UNG}USER VLESS${NC}"
