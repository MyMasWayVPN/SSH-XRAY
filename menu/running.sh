...
echo -e "  ${WH}❇️ Stunnel4                 : $status_stunnel${NC}"
#echo -e "❇️ Squid                   :$status_squid"
echo -e "  ${WH}❇️ Fail2Ban                 : $status_fail2ban${NC}"
echo -e "  ${WH}❇️ Crons                    : $status_cron${NC}"
echo -e "  ${WH}❇️ Vnstat                   : $status_vnstat${NC}"
echo -e "  ${WH}❇️ XRAYS Vmess TLS          : $status_tls_v2ray${NC}"
echo -e "  ${WH}❇️ XRAYS Vmess None TLS     : $status_nontls_v2ray${NC}"
echo -e "  ${WH}❇️ XRAYS Vless TLS          : $status_tls_vless${NC}"
echo -e "  ${WH}❇️ XRAYS Vless None TLS     : $status_nontls_vless${NC}"
echo -e "  ${WH}❇️ XRAYS Trojan             : $status_virus_trojan${NC}"
echo -e "  ${WH}❇️ Shadowsocks              : $status_shadowsocks${NC}"
echo -e "  ${WH}❇️ Websocket TLS            : $swstls${NC}"
echo -e "  ${WH}❇️ Websocket None TLS       : $swstls${NC}"
echo -e "  ${WH}❇️ OHP Dropbear             : $sohp${NC}"
